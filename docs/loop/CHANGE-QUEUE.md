...
| 9 | CHG-012 | SurfaceNets benchmark: warm the job, best-of-three medians, a harness row (F-021) | AUTO | T1 | reproduce cold, then 3 cold + 2 warm runs pass and log rows | S | SPEC |
