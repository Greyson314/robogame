...
- **Aero control surfaces (`AeroControl` / `AeroSurfaceBlock`, ADR-0009)** — replaced `PlaneControlSubsystem` in session 167 and already work in the chassis frame only (`r × liftAxis` about the CoM, no world-up reference). Nothing to do for planets.
