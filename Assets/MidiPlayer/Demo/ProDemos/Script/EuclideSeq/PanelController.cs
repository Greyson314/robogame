...
namespace MPTKDemoEuclidean
{
    ...
    IBeginDragHandler, IDragHandler, IEndDragHandler*/
    {
        ...
        /// <summary>@brief
        /// This action randomizes the controller (set by the GUI).
        /// It is processed in Update() by the main EuclideanRhythme component.
        /// </summary>
        ...
        /// <summary>@brief
        /// This action duplicates the controller (set by the GUI).
        /// It is processed in Update() by the main EuclideanRhythme component.
        /// </summary>
        ...
        public void Update()
        {
            ...
            if (PanelView.activeInHierarchy)
            {
                ...
                // Make speed dependent on tempo. With Tempo=60 bpm, there is 1 second between each hit.
                // This is the maximum time for the arrow to reach its updated position.
