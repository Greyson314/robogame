/// Simple script to load a SoundFont dynamically at startup.
/// To be done in the next Maestro version:
///     - Try to get information from the SF: MidiPlayerGlobal.ImSFCurrent.SoundFontName is not defined.
///     - Create a local cache of downloaded SF files to avoid downloading on each run.
