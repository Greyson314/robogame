...
namespace DemoMVP
{
    ...
    {
        #region Define variables visible in the Inspector
        [Header("A MidiFilePlayer prefab must exist in the hierarchy")]
        /// <summary>@brief
        /// MPTK component able to play a MIDI file from your list of MIDI files. This prefab must be present in your scene.
        /// </summary>
