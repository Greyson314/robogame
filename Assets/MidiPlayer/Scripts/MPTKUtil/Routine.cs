...
namespace MidiPlayerTK
{
    public class Routine : MonoBehaviour
    {
        ...
        public static int GetGameObjectIdentifier(GameObject gameObj)
        {
            if (gameObj == null)
                return 0;
...
#pragma warning disable 0619
            return (int)gameObj.GetEntityId().GetHashCode();
#pragma warning restore 0619
#else
#pragma warning disable 618
            return gameObj.GetInstanceID();
#pragma warning restore 618
        ...
        {
            // gameObj. Get InstanceID();
            return coroutine == null ? new CoroutineHandle() : Instance.RunCoroutineInternal(coroutine, Segment.Update,
                GetGameObjectIdentifier(gameObj), gameObj != null, null, new CoroutineHandle(Instance._instanceID), true);
        }
        ...
        {
            return coroutine == null ? new CoroutineHandle() : Instance.RunCoroutineInternal(coroutine, Segment.Update,
                GetGameObjectIdentifier(gameObj), gameObj != null, tag, new CoroutineHandle(Instance._instanceID), true);
        }
        ...
        public CoroutineHandle RunCoroutineOnInstance(IEnumerator<float> coroutine, GameObject gameObj)
        {
            return coroutine == null ? new CoroutineHandle() : RunCoroutineInternal(coroutine, Segment.Update,
                GetGameObjectIdentifier(gameObj), gameObj != null, null, new CoroutineHandle(_instanceID), true);
        }
        ...
        {
            return coroutine == null ? new CoroutineHandle() : RunCoroutineInternal(coroutine, Segment.Update,
                GetGameObjectIdentifier(gameObj), gameObj != null, tag, new CoroutineHandle(_instanceID), true);
        }
        ...
        {
            return gameObj == null ? RunCoroutine(coroutine) : RunCoroutineSingleton(coroutine, GetGameObjectIdentifier(gameObj), behaviorOnCollision);
        }
        ...
        public static CoroutineHandle RunCoroutineSingleton(IEnumerator<float> coroutine, GameObject gameObj, string tag, SingletonBehavior behaviorOnCollision)
        {
            return gameObj == null ? RunCoroutineSingleton(coroutine, tag, behaviorOnCollision)
                : RunCoroutineSingleton(coroutine, GetGameObjectIdentifier(gameObj), tag, behaviorOnCollision);
        }
        ...
        public static CoroutineHandle RunCoroutineSingleton(IEnumerator<float> coroutine, Segment segment, GameObject gameObj,
            SingletonBehavior behaviorOnCollision)
        {
            return gameObj == null ? RunCoroutine(coroutine, segment) : RunCoroutineSingleton(coroutine, segment, GetGameObjectIdentifier(gameObj), behaviorOnCollision);
        }
            ...
            SingletonBehavior behaviorOnCollision)
        {
            return gameObj == null ? RunCoroutineSingleton(coroutine, segment, tag, behaviorOnCollision)
                : RunCoroutineSingleton(coroutine, segment, GetGameObjectIdentifier(gameObj), tag, behaviorOnCollision);
        }
        ...
        public CoroutineHandle RunCoroutineSingletonOnInstance(IEnumerator<float> coroutine, GameObject gameObj, SingletonBehavior behaviorOnCollision)
        {
            return gameObj == null ? RunCoroutineOnInstance(coroutine)
                : RunCoroutineSingletonOnInstance(coroutine, GetGameObjectIdentifier(gameObj), behaviorOnCollision);
        }
            ...
            SingletonBehavior behaviorOnCollision)
        {
            return gameObj == null ? RunCoroutineSingletonOnInstance(coroutine, tag, behaviorOnCollision)
                : RunCoroutineSingletonOnInstance(coroutine, GetGameObjectIdentifier(gameObj), tag, behaviorOnCollision);
        }
            ...
            SingletonBehavior behaviorOnCollision)
        {
            return gameObj == null ? RunCoroutineOnInstance(coroutine, segment)
                : RunCoroutineSingletonOnInstance(coroutine, segment, GetGameObjectIdentifier(gameObj), behaviorOnCollision);
        }
            ...
            SingletonBehavior behaviorOnCollision)
        {
            return gameObj == null ? RunCoroutineSingletonOnInstance(coroutine, segment, tag, behaviorOnCollision)
                : RunCoroutineSingletonOnInstance(coroutine, segment, GetGameObjectIdentifier(gameObj), tag, behaviorOnCollision);
        }
        ...
        {
            return _instance == null ? 0 : _instance.KillCoroutinesOnInstance(GetGameObjectIdentifier(gameObj));
        }
        ...
        {
            return KillCoroutinesOnInstance(GetGameObjectIdentifier(gameObj));
        }
        ...
        {
            return _instance == null ? 0 : _instance.KillCoroutinesOnInstance(GetGameObjectIdentifier(gameObj), tag);
        }
        ...
        {
            return KillCoroutinesOnInstance(GetGameObjectIdentifier(gameObj), tag);
        }
        ...
        {
            return gameObj == null ? 0 : PauseCoroutinesOnInstance(GetGameObjectIdentifier(gameObj));
        }
        ...
        {
            return _instance == null ? 0 : _instance.PauseCoroutinesOnInstance(GetGameObjectIdentifier(gameObj), tag);
        }
        ...
        {
            return gameObj == null ? 0 : PauseCoroutinesOnInstance(GetGameObjectIdentifier(gameObj), tag);
        }
        ...
        {
            return _instance == null ? 0 : _instance.ResumeCoroutinesOnInstance(GetGameObjectIdentifier(gameObj));
        }
        ...
        {
            return gameObj == null ? 0 : ResumeCoroutinesOnInstance(GetGameObjectIdentifier(gameObj));
        }
        ...
        {
            return _instance == null ? 0 : _instance.ResumeCoroutinesOnInstance(GetGameObjectIdentifier(gameObj), tag);
        }
        ...
        {
            return gameObj == null ? 0 : ResumeCoroutinesOnInstance(GetGameObjectIdentifier(gameObj), tag);
        }
        ...
        public new static T FindFirstObjectByType<T>() where T : Object { return null; }

        [System.Obsolete("Just.. no.", true)]
        public new static Object FindFirstObjectByType(System.Type t) { return null; }
    ...
    public static class MECExtensionMethods1
    {
        ...
        public static CoroutineHandle RunCoroutineSingleton(this IEnumerator<float> coroutine, GameObject gameObj, SingletonBehavior behaviorOnCollision)
        {
            return gameObj == null ? Routine.RunCoroutine(coroutine) :
                Routine.RunCoroutineSingleton(coroutine, Routine.GetGameObjectIdentifier(gameObj), behaviorOnCollision);
        }
        ...
        public static CoroutineHandle RunCoroutineSingleton(this IEnumerator<float> coroutine, GameObject gameObj, string tag, SingletonBehavior behaviorOnCollision)
        {
            return gameObj == null ? Routine.RunCoroutineSingleton(coroutine, tag, behaviorOnCollision)
                : Routine.RunCoroutineSingleton(coroutine, Routine.GetGameObjectIdentifier(gameObj), tag, behaviorOnCollision);
        }
            ...
            SingletonBehavior behaviorOnCollision)
        {
            return gameObj == null ? Routine.RunCoroutine(coroutine, segment) :
                Routine.RunCoroutineSingleton(coroutine, segment, Routine.GetGameObjectIdentifier(gameObj), behaviorOnCollision);
        }
            ...
            SingletonBehavior behaviorOnCollision)
        {
            return gameObj == null ? Routine.RunCoroutineSingleton(coroutine, segment, tag, behaviorOnCollision)
                : Routine.RunCoroutineSingleton(coroutine, segment, Routine.GetGameObjectIdentifier(gameObj), tag, behaviorOnCollision);
        }
