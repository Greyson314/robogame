...
namespace MidiPlayerTK
{
    ...
    public partial class MidiPlayerGlobal : MonoBehaviour
    {
        ...
        /// <summary>@brief
        /// Should the application continue to run in the background when minimized?
        /// This sets Unity's Application.runInBackground property.
        /// Enable this for background music playback.
        /// </summary>
        public bool MPTK_RunInBackground = true;
        ...
        void Awake()
        {
            ...
            // Set Unity's runInBackground based on MPTK global setting
            Application.runInBackground = MPTK_RunInBackground;
