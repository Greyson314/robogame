...
namespace MidiPlayerTK
{
    ...
    /// @ingroup algorithmic_music_generation
    /// <summary>
    /// Preset chord progression data with mood tags and helpers that convert Roman numerals
    /// into playable chord-library entries (MPTKChordName + tonic).
    ...
    public class MPTKChordProgressionPreset
    {
        ...
        /// <param name="mode">Tonal mode used by the progression.</param>
        /// <param name="genre">Style family of the progression.</param>
        /// <param name="harmonyFlavor">Harmonic language classification.</param>
        /// <param name="moodTags">Mood keywords attached to the preset.</param>
        /// <param name="degrees">Progression steps in Roman-degree notation.</param>
        /// <param name="example">Human-readable progression example.</param>
        /// <param name="intensity">Subjective energy rating from 1 (low) to 5 (high).</param>
        /// <param name="harmonicTension">Subjective harmonic tension rating from 1 (low) to 5 (high).</param>
    ...
    public struct MPTKResolvedChordStep
    {
        ...
        /// </summary>
        /// <param name="degreeToken">Original degree token that was parsed.</param>
        /// <param name="tonicMidi">Resolved root MIDI note for this step.</param>
        /// <param name="chordName">Resolved chord-library entry.</param>
        /// <param name="isApproximation">True when an approximation or fallback was required.</param>
        /// <param name="note">Additional note describing approximation details.</param>
    ...
    public static class MPTKChordProgressionLib
    {
        ...
        /// <summary>
        /// Resolves a progression to concrete tonic and chord-library entries.
        ...
        /// <returns>Resolved chord steps ready to map to chord-library names and tonic notes.</returns>
        ...
        /// <summary>
        /// Builds `MPTKChordBuilder` instances from Roman-degree tokens.
        /// Example playback target: `MidiStreamPlayer.MPTK_PlayChordFromLib()`.
        /// </summary>
        /// <param name="degreeTokens">Progression steps in Roman-degree notation.</param>
        /// <param name="tonicMidi">MIDI note number used as the tonic reference for degree I/i.</param>
        /// <param name="channel">Target MIDI channel from 0 to 15.</param>
        /// <param name="velocity">Default note velocity from 0 to 127.</param>
        /// <param name="duration">Chord duration in milliseconds (-1 for indefinite).</param>
        /// <param name="delayBetweenChords">Delay in milliseconds inserted between generated chords.</param>
        /// <returns>A list of configured `MPTKChordBuilder` instances.</returns>
