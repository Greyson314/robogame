    ...
    public class MidiPlayerGlobalEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            try
            {
                ...
                instance.MPTK_RunInBackground = EditorGUILayout.Toggle(
                    new GUIContent("Run In Background", 
                        "Allow the application to continue running when minimized. This enables background music playback. " +
                        "Note: On desktop platforms, this works with 'Pause on loss of focus' setting in MidiFilePlayer. " +
                        "On mobile platforms, the OS may restrict background execution."),
                    instance.MPTK_RunInBackground);
