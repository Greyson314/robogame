...
namespace Robogame.Combat
{
    ...
    public sealed class BombDefinition : WeaponStatsDefinition
    {
        [Header("Bomb drop")]
        ...
        // The bomb's "fire interval" is its drop interval. DropInterval stays
        // as the named accessor the bomb-bay firer reads.
        public override float FireInterval => _dropInterval;
