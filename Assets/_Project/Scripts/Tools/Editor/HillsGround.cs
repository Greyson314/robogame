...
namespace Robogame.Tools.Editor
{
    ...
    public static class HillsGround
    {
        ...
        private static void BakeInto(Mesh mesh, HillsSettings s)
        {
            ...
            // Single submesh — grass grows everywhere; the Fluff shader
            // darkens it on steeper slopes (FluffGround _SlopeDarken*) so
            // cliff faces read as dark mossy slopes rather than bare rock.
